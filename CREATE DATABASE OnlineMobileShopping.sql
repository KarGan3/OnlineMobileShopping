...
CREATE TABLE CartItems (
    ...
    FOREIGN KEY (mobile_model) REFERENCES Mobiles(model) ON DELETE CASCADE
);
...
CREATE TABLE Payments (
    ...
    payment_method VARCHAR(50) CHECK (payment_method IN ('Credit Card', 'Debit Card', 'UPI', 'Net Banking', 'Cash on Delivery')) NOT NULL,
    status VARCHAR(50) CHECK (status IN ('Successful', 'Failed')) DEFAULT 'Successful',
...
('Apple', 'iPhone 13 Pro', 1299.99,'Alphine Green', '6.1-inch ProMotion OLED, Triple Camera, 1TB Storage', 55, 1),
...
('Apple', 'iPhone 13 Pro Max', 1399.99,'Alphine Green', '6.7-inch ProMotion OLED, Triple Camera, 1TB Storage', 50, 1),
...
('Apple', 'iPhone 14 Pro', 1399.99,'Space c', '6.1-inch ProMotion OLED, Dynamic Island, 1TB Storage', 40, 1),
...
-- Cart data
INSERT INTO Cart (user_name, created_at) VALUES
('Tasneem', '2025-04-01 10:15:23'),
('Prem', '2025-04-02 14:30:45'),
('Bhanu', '2025-04-03 09:10:12'),
('Karthikeya', '2025-04-04 16:25:37'),
('Nishanth', '2025-04-05 11

:45:00'),
('Lokesh', '2025-04-05 20:15:19'),
('Vamsi', '2025-04-06 08:30:55'),
('Tharun', '2025-04-06 13:20:40');

-- CartItems data
INSERT INTO CartItems (cart_id, mobile_model, quantity) VALUES
(1, 'iPhone', 2),       -- Tasneem's cart: 2 iPhones (White)
(2, 'iPhone 4', 1),     -- Prem's cart: 1 iPhone 4 (Black)
(3, 'iPhone 5', 3),     -- Bhanu's cart: 3 iPhone 5 (Black)
(4, 'iPhone 5s', 1),    -- Karthikeya's cart: 1 iPhone 5s (Silver)
(5, 'iPhone 6', 2),     -- Nishanth's cart: 2 iPhone 6 (Silver)
(6, 'iPhone 6s', 1),    -- Lokesh's cart: 1 iPhone 6s (Silver)
(7, 'iPhone 7', 1),     -- Vamsi's cart: 1 iPhone 7 (Silver)
(8, 'iPhone 8', 2);     -- Tharun's cart: 2 iPhone 8 (Silver)

-- Orders data
INSERT INTO Orders (user_name, order_date, status, total_price) VALUES
('Tasneem', '2025-04-03 12:00:00', 'Shipped', 799.98),    -- Tasneem: 2 iPhones
('Prem', '2025-04-04 15:30:00', 'Delivered', 699.99),     -- Prem: 1 iPhone 4
('Bhanu', '2025-04-05 09:15:00', 'Pending', 2399.97),     -- Bhanu: 3 iPhone 5s
('Karthikeya', '2025-04-06 10:00:00', 'Cancelled', 699.99), -- Karthikeya: 1 iPhone 5s
('Nishanth', '2025-04-06 14:45:00', 'Shipped', 1799.98);   -- Nishanth: 2 iPhone 6s

-- OrderDetails data
INSERT INTO OrderDetails (order_id, mobile_model, quantity, price) VALUES
(1, 'iPhone', 2, 399.99),    -- Tasneem's order: 2 iPhones (White)
(2, 'iPhone 4', 1, 699.99),  -- Prem's order: 1 iPhone 4 (Black)
(3, 'iPhone 5', 3, 799.99),  -- Bhanu's order: 3 iPhone 5 (Black)
(4, 'iPhone 5s', 1, 699.99), -- Karthikeya's order: 1 iPhone 5s (Silver)
(5, 'iPhone 6', 2, 899.99);  -- Nishanth's order: 2 iPhone 6 (Silver)
...
-- Reviews data
INSERT INTO Reviews (user_name, mobile_model, rating, comment, review_date) VALUES
('Tasneem', 'iPhone', 4, 'Great phone for its time!', '2025-04-04 10:00:00'),         -- Tasneem on iPhone
('Prem', 'iPhone 4', 5, 'Love the Retina display!', '2025-04-05 12:30:00'),          -- Prem on iPhone 4
('Bhanu', 'iPhone 5', 3, 'Good, but battery life could be better.', '2025-04-06 08:15:00'), -- Bhanu on iPhone 5
('Nishanth', 'iPhone 6', 4, 'Solid upgrade, sleek design.', '2025-04-06 15:00:00'),     -- Nishanth on iPhone 6
('Vamsi', 'iPhone 7', 5, 'No headphone jack, but amazing performance!', '2025-04-06 16:00:00'); -- Vamsi on iPhone 7